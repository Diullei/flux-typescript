...
export type DispatchCallbackFunc<TPayload> = (payload: TPayload) => void;
...
export default class Dispatcher<TPayload> {
    private _callbacks: Map<DispatchCallbackFunc<TPayload>> = {};
    private _isDispatching: boolean = false;
    private _isHandled: Map<boolean> = {};
    private _isPending: Map<boolean> = {};
     ...
     */
    public register(callback: DispatchCallbackFunc<TPayload>): DispatchToken {
    ...
    /**
     * The "waitFor" name is confusing.
     */
    public perform = this.waitFor;
